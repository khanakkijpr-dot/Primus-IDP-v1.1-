...
const HomePage = () => {
	...
	const saveDatamessage = async () => {
		...
		toast({
			...
			description: "Saving captured content to Primus IDP",
		});
					...
					<div className="w-full max-w-md space-y-8">
						<div className="flex flex-col items-center space-y-2 text-center">
							<div className="rounded-full bg-gray-800 p-3 shadow-lg ring-2 ring-gray-700">
								<img className="h-12 w-12" src={icon} alt="Primus IDP" />
							</div>
							<h1 className="mt-4 text-3xl font-semibold tracking-tight text-white">Primus IDP</h1>
					...
					<div className="flex items-center justify-between border-b border-gray-700 pb-4">
						<div className="flex items-center space-x-3">
							<div className="rounded-full bg-gray-800 p-2 shadow-md ring-1 ring-gray-700">
								<img className="h-6 w-6" src={icon} alt="Primus IDP" />
							</div>
							<h1 className="text-xl font-semibold text-white">Primus IDP</h1>
						</div>
						<Button
							variant="ghost"
							size="icon"
