...
There are two ways to install Primus IDP, but both require the repository to be cloned first. Clone [Primus IDP](https://github.com/khanakkijpr-dot/Primus-IDP) and then:
