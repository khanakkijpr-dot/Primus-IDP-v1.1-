			...
			<div className="relative flex flex-col items-center overflow-hidden lg:items-start">
				<div className="flex items-start justify-start">
					<FeatureIconContainer className="flex items-center justify-center overflow-hidden">
						<IconMailFilled className="h-6 w-6 text-[#3D2B1F]" />
				...
				<div className="mt-10 hidden flex-col items-center gap-4 md:flex-row lg:flex">
					<Link
						href="mailto:rohan@primusidp.com"
					...
					<Link
						href="https://cal.com/mod-Primus IDP"
						className="text-sm text-neutral-500 dark:text-neutral-400"
					>
						https://cal.com/mod-Primus IDP
					</Link>
				</div>
		...
		>
			<div className="h-full w-full">
				<div className="absolute inset-x-0 top-0 z-20 mx-auto inline-block w-fit rounded-lg bg-neutral-200 px-2 py-1 text-xs font-normal text-neutral-700 dark:bg-neutral-800 dark:text-white">
					We are here
					<span className="absolute -bottom-0 left-[1.125rem] h-px w-[calc(100%-2.25rem)] bg-gradient-to-r from-[#A89F91]/0 via-[#A89F91]/90 to-[#A89F91]/0 transition-opacity duration-500"></span>
				</div>
				...
				<>
					<motion.div className="absolute right-1/2 bottom-1/2 h-20 w-px translate-y-[14px] bg-gradient-to-b from-transparent to-[#3D2B1F] blur-[2px]" />
					<motion.div className="absolute right-1/2 bottom-1/2 h-20 w-px translate-y-[14px] bg-gradient-to-b from-transparent to-[#3D2B1F]" />
					<motion.div className="absolute right-1/2 bottom-1/2 z-40 h-[4px] w-[4px] translate-x-[1.5px] translate-y-[14px] rounded-full bg-[#5C524C] blur-[3px]" />
					<motion.div className="absolute right-1/2 bottom-1/2 z-40 h-[2px] w-[2px] translate-x-[0.5px] translate-y-[14px] rounded-full bg-[#A89F91]" />
				</>
			</div>
		</motion.div>
	);
...
export const FeatureIconContainer = ({
	...
	return (
		...
		>
			...
			<div className="absolute inset-x-0 bottom-0 mx-auto h-px w-[60%] bg-gradient-to-r from-transparent via-[#3D2B1F] to-transparent"></div>
			<div className="absolute inset-x-0 bottom-0 mx-auto h-px w-[60%] bg-gradient-to-r from-transparent via-[#5C524C] to-transparent dark:h-[8px] dark:blur-sm"></div>
		</div>
	);
};
