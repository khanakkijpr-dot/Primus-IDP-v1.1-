...
本指南将帮助你在 Primus IDP 中配置和使用国产大语言模型。

This guide helps you configure and use Chinese LLM providers in Primus IDP.

---

## 📋 支持的提供商 | Supported Providers

Primus IDP 现已支持以下国产 LLM：
